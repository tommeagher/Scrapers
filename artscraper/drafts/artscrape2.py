...
spam = soup.find('table', {"class" : "GuideResultInfoWrapper"})
name = spam.find('div', {"class" : "GuideResultListingName"}).a.string
street = spam.find('div', {"class" : "GuideResultAddress"}).span.string
...
#    for row in table.findAll('div', {"class": "GuideResultListingName"}):
